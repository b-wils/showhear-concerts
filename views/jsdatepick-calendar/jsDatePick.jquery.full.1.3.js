...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "jsdatepick-calendar/img/";
...
JsDatePick.prototype.setConfiguration = function (aConf) {
    ...
    //this.selectedDayObject = new Date();
    this.selectedDayObject = {};
    this.flag_DayMarkedBeforeRepopulation = false;

    this.flag_aDayWasSelected = this.oConfiguration.selectedDate = (aConf["selectedDate"] != null) ? true : false;
